...
class CabClient:
    ...
    def register_user(self):
        ...
        try:
            ...
            result = self.server.register_user(username, password, user_type)
            if result["success"]:
    ...
    def login_user(self):
        ...
        try:
            ...
            result = self.server.authenticate_user(username, password)
            if result["success"]:
    ...
    def book_cab(self):
        ...
        try:
            ...
            result = self.server.book_cab(self.current_user, pickup, destination)
            if result["success"]:
    ...
    def check_ride_status(self):
        ...
        try:
            ...
            result = self.server.get_ride_status(ride_id)
            if result["success"]:
    ...
    def view_available_cabs(self):
        ...
        try:
            ...
            result = self.server.get_available_cabs(location)
            if result["success"]:
                cabs = result["cabs"]
                if cabs:
    ...
    def set_driver_available(self):
        ...
        try:
            ...
            result = self.server.set_driver_available(self.current_user, location)
            if result["success"]:
                print(result["message"])
            else:
                print(f"Error: {result['message']}")
    ...
    def show_system_stats(self):
        ...
        try:
            ...
            active_rides_result = self.server.get_active_rides()
            available_drivers_result = self.server.get_available_drivers()
